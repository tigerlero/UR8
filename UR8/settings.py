"""
Django settings for UR8 project.
...
ALLOWED_HOSTS = ['http://localhost', "http://127.0.0.1", 'https://ur8.onrender.com']
...
WSGI_APPLICATION = "UR8.wsgi.application"
...
# Define the URL endpoint for static files
STATIC_URL = '/static/'
